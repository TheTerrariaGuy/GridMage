...
Water joins all eight neighbors like stone, including filled 2×2 corners. `Water_0` through `Water_46` correspond directly to variants 2–48, except for T-junctions and four-way junctions. T-junctions use thick artwork on all three connected sides regardless of diagonals:
...
Base, spent, and fading states below suffix 10 connect within their element family. Shape entries on the base type apply to all these stages; a stage-specific shape entry overrides them. Reaction states (110/111, 210/211, 310/311, 410/411) stay separate and use isolated fire, water, lightning, and fire artwork respectively, alongside their existing particle effects.
