...
{
    private const string Folder = "Assets/Levels/Elevation";
    ...
    public static void Configure()
    {
        ...
        if (!AssetDatabase.IsValidFolder(Folder)) AssetDatabase.CreateFolder("Assets/Levels", "Elevation");
        ...
        var flat = AssetDatabase.LoadAssetAtPath<LevelMarkerTile>("Assets/Levels/Floor.asset");
    ...
    {
        const string path = Folder + "/Elevation Palette.prefab";
        if (AssetDatabase.LoadAssetAtPath<GameObject>(path) == null)
            GridPaletteUtility.CreateNewPalette(Folder, "Elevation Palette", GridLayout.CellLayout.Rectangle,
        ...
        try
        {
            ...
            for (int i = 0; i < names.Length; i++)
                map.SetTile(new Vector3Int(i, -3, 0), AssetDatabase.LoadAssetAtPath<LevelMarkerTile>("Assets/Levels/" + names[i] + ".asset"));
